        ...
        <div>
          <div className="flex items-center gap-2">
            ...
            <h3 className="text-lg font-bold text-slate-900">
              Deterministic Strategy Evaluation Matrix
            </h3>
          </div>
          <p className="text-xs text-slate-500 mt-0.5">
            Objective mathematical ranking combining Speed (30%), Revenue Protection (25%), Cost (25%), and SLA Impact (20%).
          </p>
        </div>
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <div>
                        <div className="font-bold text-slate-900 flex items-center gap-1.5">
                          {strat.strategy_name}
                          {isWinner && (
                            <span className="text-[10px] uppercase font-extrabold px-1.5 py-0.2 rounded bg-emerald-600 text-white">
                              RECOMMENDED
                            </span>
                          )}
                        </div>
